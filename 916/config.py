...
COLUNA_FINAL = "M"    # Última coluna a ser preenchida

# ======================================
# CONFIGURAÇÕES DE COLUNAS PARA PULAR
# ======================================
COLUNAS_PULAR = []  # Colunas que o robô deve pular (só dar tab, não inserir dados)
TEMPO_TAB_PULAR = 0.1

# ======================================
# CONFIGURAÇÕES DE DIGITAÇÃO - MAIS RÁPIDO
# ======================================
TEMPO_ENTRE_CARACTERES = 0.04  # ALTERADO: era 0.1, agora 0.03 (3x mais rápido)

# ======================================
# OUTRAS CONFIGURAÇÕES
# ======================================
EMPRESA_PADRAO = 200  # Número da empresa para login
INTERVALO_ENTRE_ACOES = 0.6  # ALTERADO: era 0.7, agora 0.5 (mais rápido)
