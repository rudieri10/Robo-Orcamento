...
COLUNA_FINAL = "W"    # Última coluna a ser preenchida

# ======================================
# CONFIGURAÇÕES DE COLUNAS PARA PULAR
# ======================================
COLUNAS_PULAR = ["G","H","J","N","O","Q","R","T","V","W"]  # Colunas que o robô deve pular (só dar tab, não inserir dados)
TEMPO_TAB_PULAR = 0.1
# ======================================
# CONFIGURAÇÕES DE DIGITAÇÃO
# ======================================
TEMPO_ENTRE_CARACTERES = 0.1  # Tempo em segundos entre cada caractere digitado

# ======================================
# OUTRAS CONFIGURAÇÕES
# ======================================
EMPRESA_PADRAO = 200  # Número da empresa para login
INTERVALO_ENTRE_ACOES = 1 # Tempo em segundos entre cada ação
