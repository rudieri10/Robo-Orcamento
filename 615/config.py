...
COLUNA_FINAL = "P"    # Última coluna a ser preenchida

# ======================================
# CONFIGURAÇÕES DE COLUNAS PARA PULAR
# ======================================
COLUNAS_PULAR = ["H", "J" ,"O"  ,"P"]  # Colunas que o robô deve pular (só dar tab, não inserir dados)
TEMPO_TAB_PULAR = 0.1
...
INTERVALO_ENTRE_ACOES = 0.5  # ALTERADO: era 0.7, agora 0.5 (mais rápido)
